...
def fourier_series_symbo():
    ...
    for function in request.json["functions"]:
        ...
        a0_integral_expr = a0_integral_expr.replace("+C", "")
        steps["ctitle"] = "Obtenemos la integral de $$a_0$$"
        global_steps.append(steps)
    ...
    for function in request.json["functions"]:
        ...
        steps["ctitle"] = "Obtenemos la integral de $$a_n$$"
        global_steps.append(steps)
    ...
    for function in request.json["functions"]:
        ...
        steps["ctitle"] = "Obtenemos la integral de $$b_n$$"
        global_steps.append(steps)
...
def compleja():
    ...
    for function in functions:
        ...
        steps["ctitle"] = "Vemos si la función converge"
        global_steps.append(steps)
...
def fourier_trans():
    ...
    for function in request["functions"]:
        ...
        steps['ctitle'] = 'Obtenemos la tranformada'
